/*------------------------------------------------------------------------------
  ...
  2020/08/24  KBB     Initial version (BK-518)
...
/******************************************************************************/
/******************************************************************************/
/* Rules to update LPNs after creeation of LPN */
/******************************************************************************/
/******************************************************************************/
select @vRuleSetType   = 'CreateLPNs_OnCreateOfLPNs';

delete from @RuleSets;
delete from @Rules;

/******************************************************************************/
/* Rule Set to update additional info on LPNs  */
/******************************************************************************/
select @vRuleSetName        = 'CreateLPNs_UpdateLPNs',
       @vRuleSetFilter      = null,
       @vRuleSetDescription = 'Create LPNs: Update additional info on LPNs',
       @vStatus             = 'I' /* In-Active */,
...
/*----------------------------------------------------------------------------*/
/* Rule placeholder to be used as needed */
select @vRuleCondition   = null,
       @vRuleDescription = 'Update LPN....',
       @vRuleQuery       = '',
       @vRuleQueryType   = 'Update',
