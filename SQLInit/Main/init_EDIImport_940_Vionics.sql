...
/*------------------------------------------------------------------------------*/
/* 940 Mapping for Vasyli */
/*------------------------------------------------------------------------------*/

select @vProfileName    = 'Vasyli940';
...
insert into @ttEDIPM select  'CLEARDATA',     'W05',      null,                         null,      null,               'PKGComments',      null,              null,        null
...
insert into @ttEDIPM select  'ADDXMLFIELD',   'W05',      null,                         null,      'Priority',          null,              '5',               null,        null
...
insert into @ttEDIPM select  'ADDXMLFIELD',   'NTE',      null,                         null,      'Comments',         null,              '[PKGComments]',   null,         null
...
insert into @ttEDIPM select  'ADDXMLFIELD',   'W01',      'W0104=VC',                   'W0105',   'SKU1',              null,              null,              null,        null
...
/* Freight Class */
insert into @ttEDIPM select  'ADDXMLFIELD',   'W01',      null,                         'W0108',   'UDF1',              null,              null,             null,        null
/* Rate Class */
insert into @ttEDIPM select  'ADDXMLFIELD',   'W01',      null,                         'W0109',   'UDF2',              null,              null,             null,        null
