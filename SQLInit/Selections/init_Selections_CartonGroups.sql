/*------------------------------------------------------------------------------
  ...
  2020/09/24  HYP       Initial revision (HA-796)
------------------------------------------------------------------------------*/

Go

declare @ContextName           TName = 'List.CartonGroups',
        @SelectionName         TName,
...
select @SelectionName        = 'ActiveCartonGroups',
       @SelectionDescription = 'Active CartonGroups';

insert into @ttSelectionFilters
            (FilterType, FieldName,          FilterOperation,    FilterValue,        Visible)
      select 'D',        'CGT_Status',       'Equals',           'A',                'Y'
