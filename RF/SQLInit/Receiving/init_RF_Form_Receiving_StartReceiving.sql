/*------------------------------------------------------------------------------
  ...
  2020/09/11  RIA     Corrected form name (JL-296)
...
select @vFormName = 'Receiving_StartReceiving';
delete from AMF_Forms where FormName = @vFormName;

insert into AMF_Forms(FormName, DisplayCaption, DeviceCategory, BusinessUnit, RawHtml)
select @vFormName, 'Start Receiving', 'STD', BusinessUnit,
'
<div class="amf-form-header-container">
  <div class="container">
    <div class="amf-form-heading">
      ...
      <span class="amf-form-heading-title js-amf-menu-title">Start Receiving</span>
...
<div class="amf-form-layout-container">
  <div class="container">
    <input  type="hidden" data-rfname="Operation" value="ReceiveInventory" />
