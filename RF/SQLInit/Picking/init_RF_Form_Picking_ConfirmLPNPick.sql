...
select @vFormName = 'Picking_ConfirmLPNPick';
...
<div class="amf-form-layout-container" data-rfsubmitpreprocess="Picking_ConfirmUnitPick_ProcessInputs" data-rfshowpreprocess="Picking_ConfirmLPNPick_OnShow">
  <div class="container">
    ...
    <div class="amf-form-operation-info">
      ...
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-8 col-xs-8 amf-slide-details-responsive">
            <span>[FIELDVALUE_PickTicket]</span>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="form-group">
          ...
          <div class="col-md-8 col-xs-8 amf-slide-details-responsive">
            <span>[FIELDVALUE_NumOrders]</span>
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-4 col-xs-4 amf-slide-details-responsive">
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-md-7 col-xs-7 amf-data-layout-responsive" style="border-right:1px solid #ccc;">
                  ...
                  <span class="amf-display-value-small" data-rfvisibility="COMPAREWITH" data-rfvisiblevalue="[FIELDVALUE_LPNPickInfo_LocationType]" data-rfvisiblecomparewith="R,B">[FIELDVALUE_LPNPickInfo_LPN]</span>
                </div>
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-xs-8 amf-data-layout-responsive" style="border-right:1px solid #ccc;">
                  <span class="amf-display-value-medium">[FIELDVALUE_LPNPickInfo_SKU]</span>
                  <span class="amf-display-value-small">[FIELDVALUE_LPNPickInfo_UPC]</span>
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-xs-4 amf-data-layout-responsive">
                  ...
                  data-rfvalidationset="NOTNULL" data-rftabindex="1">
                </div>
                <div class="col-md-4 col-xs-4 amf-data-layout-responsive" data-rfvisibility="NOTNULL" data-rfvisiblevalue="[FIELDVALUE_LPNPickInfo_ScanPickToCaption]">
                  <label class="col-form-label">Scan SKU</label>
                  <input type="text" class="form-control amf-form-control" data-rfname="PickedTo" data-displaycaption="[FIELDVALUE_LPNPickInfo_ScanPickToCaption]" value="" data-rfvalidationset="NOTNULL" data-rfenabled="COMPAREWITH" data-rfenabledvalue="[FIELDVALUE_OPTIONSEnablePickToLPN]" data-rfenabledcomparewith="Y" data-rfsubmitform="true" data-rftabindex="2"/>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="amf-data-layout-btns">
                <div class="col-md-4 col-xs-4 amf-button-layout-responsive">
                  <button type="button" class="btn btn-default" data-rfclickhandler="Picking_ConfirmLPNPick_SkipPick">Skip Pick</button>
                </div>
                <div class="col-md-4 col-xs-4 amf-button-layout-responsive">
                  <button type="button" class="btn btn-default" data-rfclickhandler="Picking_ConfirmLPNPick_PausePicking">Pause/Stop</button>
                </div>
                <div class="col-md-4 col-xs-4 amf-button-layout-responsive">
