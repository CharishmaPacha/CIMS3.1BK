...
select @vFormName = 'Picking_LPNPick_GetPick';
delete from AMF_Forms where FormName = @vFormName;

insert into AMF_Forms(FormName, DisplayCaption, DeviceCategory, BusinessUnit, RawHtml)
select @vFormName, 'LPN Picking - Get Task To Pick', 'STD', BusinessUnit,
'
<div class="amf-form-header-container">
  <div class="container">
    <div class="amf-form-heading">
      ...
      <span class="amf-form-heading-title js-amf-menu-title">LPN Picking - Get Task To Pick</span>
  ...
  <div class="container">
    ...
    <input  type="hidden" data-rfname="Operation"value="CustomerOrderPicking" />
      <div class="row">
        ...
        <div class="col-md-6 col-xs-6 amf-form-input-responsive-width">
          <div class="form-group">
            <input type="text" name="TaskId"  placeholder="[FIELDCAPTION_AMFTaskId_PH]" data-rfname="TaskId" data-displaycaption="[FIELDCAPTION_TaskId]" value="" data-rfvalidationset="ISNUMBER" data-rfsubmitform="true" data-rftabindex="2">
