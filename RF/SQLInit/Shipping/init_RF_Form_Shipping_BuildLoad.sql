...
select @vFormName = 'Shipping_BuildLoad';
delete from AMF_Forms where FormName = @vFormName;

insert into AMF_Forms(FormName, DisplayCaption, DeviceCategory, BusinessUnit, RawHtml)
select @vFormName, 'Build Pallet/LPN', 'STD', BusinessUnit,
'
<div class="amf-form-header-container">
  <div class="container">
    <div class="amf-form-heading">
      ...
      <span class="amf-form-heading-title js-amf-menu-title">Build Pallet/LPN</span>
...
<div class="amf-form-container">
  <div class="amf-form-layout-container">
    <input type="hidden" data-rfname="Operation" value="BuildLoad">
        ...
        <div class="amf-datacard-container">
          ...
          <div class="amf-datacard">
            <div class="col-md-6 col-sm-6 col-xs-6 amf-border-separate">
              ...
              <span class="amf-display-value">[FIELDVALUE_LoadInfo_ShipToName]</span>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-6">
              <label class="col-form-label">[FIELDCAPTION_Trailer]</label>
              <span class="amf-display-value">[FIELDVALUE_LoadInfo_TrailerNumber]</span>
            </div>
          </div>
          <div class="amf-datacard">
            <div class="col-md-6 col-sm-6 col-xs-6 amf-border-separate">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              <label class="col-form-label">[FIELDCAPTION_OnLoad]</label>
          ...
          <div class="amf-datacard">
            ...
            <div class="col-md-6 col-sm-6 col-xs-6">
              <label class="col-form-label">[FIELDCAPTION_ShipDate]</label>
              <span class="amf-display-value">[FIELDVALUE_LoadInfo_DesiredShipDate]</span>
            </div>
          </div>
        </div>
